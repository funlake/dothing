				...
				<div class="panel-wrapper panel-chart-dashboard fixed">
					...
					<div class="panel ">
						...
						<div class="content">
							...
							<div id="raphael-graph-years" class="graph">
							...
							<div class="chart-dashboard">
								...
								<ul class="chart-dashboard-items">
							...
							<ul class="content-gallery fixed">
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-1.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-1.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-2.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-2.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-3.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-3.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-4.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-4.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-5.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-5.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-6.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-6.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-7.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-7.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-8.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-8.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-9.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-9.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-10.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-10.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-11.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-11.jpg" alt="" />
								...
								<li>
									...
									<div>
										...
										<a href="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-large-12.jpg" rel="gallery">
									...
									<img src="<?php echo DO_THEME_BASE;?>/_content/panel-gallery/gallery-item-small-12.jpg" alt="" />
					...
					<div class="panel">
						...
						<div class="tabs-content">
							...
							<div id="tab-01-content" class="active">
								...
								<p>
									Quisque sollicitudin, felis id venenatis consectetur, sem sem rutrum lectus, ut tristique metus augue ac justo. Suspendisse mauris lectus, scelerisque nec commodo in, aliquet a ligula. Praesent auctor lobortis adipiscing. Nulla  elit massa, ultrices in iaculis nec, elementum a magna. Pellentesque ut magna id nunc iaculis facilisis.

								</p>
								
								
								<p>
									Pellentesque tincidunt est nec odio fringilla bibendum. Aenean in justo neque, non lobortis ante. Vestibulum vitae turpis ut erat pretium eleifend et vel lorem. Donec nibh mauris, fermentum a elementum at, pretium et velit. Curabitur auctor ante a justo consequat tristique. Nulla facilisi. Cras sem risus, dictum placerat ullamcorper id, tempus nec tortor. Aenean sollicitudin pulvinar enim, at condimentum mauris mollis vel.	
							...
							<div id="tab-03-content">
								...
								<p>
									Felis id venenatis consectetur, sem sem rutrum lectus, ut tristique metus augue ac justo. Suspendisse mauris lectus, scelerisque nec commodo in, aliquet a ligula. Praesent auctor lobortis adipiscing. Nulla  elit massa, ultrices in iaculis nec, elementum a magna. Pellentesque ut magna id nunc iaculis facilisis.
