	...
	<form class="form-horizontal" id="Afm" method="post">
		...
		<div class="btn-group  col-lg-3">
			...
			<ul class="dropdown-menu">
				<li><a href='javascript:void(0)' onclick="location.href='http://localhost/dothing/demo/index.php/ads007/module/add'"><i class="glyphicon glyphicon-plus"></i> Add</a></li>
				<!-- 	    <li class="divider"></li> -->
...
<div class="row">
	<table class="table table-striped table-bordered table-hover">
		<thead>
			<tr>
				<th width="5%" >Id</th>
				<th width="30%"><a href='http://localhost/dothing/demo/index.php/ads007/module/index@_doorder=name&_dosort=desc'>Name</a></th>
				<th width="25%">Interface</th>
				<th width="10%"><a href='http://localhost/dothing/demo/index.php/ads007/module/index@_doorder=ordering&_dosort=desc'>Ordering</a></th>
...
<?php $item_0=(array)$item_0; ?>
		...
		<tr>
			...
			<td>
				<?php echo showEditLink('id='.$item_0['id'],'ads007/module/edit')?>
				...
				<div class="modal fade" id="DOModal_<?php echo $item_0['id']?>">
					<div class="modal-dialog">
						<div class="modal-content">
							<form id="form<?php echo $item_0['id']?>" action="http://localhost/dothing/demo/index.php/autocrud/Delete/module" method="post">
								...
								<div class="modal-footer">
									...
									<a data-dismiss="modal" class="btn btn-warning">
										...
										Cancel									</a>
									<input type="hidden" name="__redirect" value="http://localhost/dothing/demo/index.php/ads007/module/"/>
