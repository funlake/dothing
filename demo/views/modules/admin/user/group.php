	...
	<form class="form-horizontal" id="Afm" method="post">
		...
		<div class="btn-group  col-lg-3">
			...
			<ul class="dropdown-menu">
				<li><a href='javascript:void(0)' onclick="location.href='http://192.168.1.14:8888/dothing/demo/index.php/ads007/user/addgroup'"><i class="glyphicon glyphicon-plus"></i> 添加</a></li>
				<!-- 	    <li class="divider"></li> -->
...
<div class="row">
	<table class="table table-striped table-bordered table-hover">
		<thead>
			<tr>
				<th width="5%" >Id</th>
				<th width="30%"><a data-toggle='post' data-link='http://192.168.1.14:8888/dothing/demo/index.php/manage/group' class='sorter' data-key='order,sort' data-value='g.name,desc' href='javascript:void(0);'>名称</a></th>
				<th width="25%">角色</th>
				<th width="10%"><a data-toggle='post' data-link='http://192.168.1.14:8888/dothing/demo/index.php/manage/group' class='sorter' data-key='order,sort' data-value='g.ordering,desc' href='javascript:void(0);'>排序</a></th>
				<th width="10%">状态</th>
				<th>操作</th>
			</tr>
		</thead>
...
<?php $item_0=(array)$item_0; ?>
		...
		<tr>
			...
			<td><a href="http://192.168.1.14:8888/dothing/demo/index.php/manage/group-<?php echo $item_0['id']?>"><?php echo $item_0['name']?></a></td>
