	...
	<form class="form-horizontal" id="Afm" method="post">
		...
		<div class="btn-group  col-lg-3">
			...
			<ul class="dropdown-menu">
				<li><a href='javascript:void(0)' onclick="location.href='http://localhost/dothing/demo/index.php/ads007/user/addoperation'"><i class="glyphicon glyphicon-plus"></i> 添加</a></li>
				<!-- 	    <li class="divider"></li> -->
...
<div class="row">
	<table class="table table-striped table-bordered table-hover">
		<thead>
			<tr>
				<th width="5%"><a data-toggle='post' data-link='http://localhost/dothing/demo/index.php/ads007/user/operation' class='sorter' data-key='order,sort' data-value='id,desc' href='javascript:void(0);'>Id</a></th>
				<th width="30%"><a data-toggle='post' data-link='http://localhost/dothing/demo/index.php/ads007/user/operation' class='sorter' data-key='order,sort' data-value='name,desc' href='javascript:void(0);'>名称</a></th>
				<th width="10%"><a data-toggle='post' data-link='http://localhost/dothing/demo/index.php/ads007/user/operation' class='sorter' data-key='order,sort' data-value='state,desc' href='javascript:void(0);'>状态</a></th>
				<th>Actions</th>
			</tr>
		</thead>
...
<?php $item_0=(array)$item_0; ?>
		...
		<tr >
			...
			<td data-toggle="tooltip" title="<?php echo $item_0['description']?>"s><a  href="http://localhost/dothing/demo/index.php/ads007/user/editoperation@id=<?php echo $item_0['id']?>"><?php echo $item_0['name']?></a></td>
				...
				<div class="modal fade" id="DOModal_<?php echo $item_0['id']?>">
					<div class="modal-dialog">
						<div class="modal-content">
							<form id="form<?php echo $item_0['id']?>" action="http://localhost/dothing/demo/index.php/autocrud/Delete/operation" method="post">
								...
								<div class="modal-footer">
									...
									<a data-dismiss="modal" class="btn btn-sm btn-warning">
										...
										取消									</a>
									<input type="hidden" id="__redirect" name="__redirect" value="http://localhost/dothing/demo/index.php/ads007/user/operation"/>
