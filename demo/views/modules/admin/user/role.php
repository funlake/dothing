	...
	<form class="form-inline" id="Afm" method="post">
		...
		<div class="btn-group pull-right">
				...
				<ul class="dropdown-menu">
					<li><a href='javascript:void(0)' onclick="location.href='<?php echo Url(DO_ADMIN_INTERFACE.'/user/addrole','');?>'"><i class="icon-plus"></i> <?php echo L('Add');?></a></li>
					<!-- 	    <li class="divider"></li> -->
...
<?php $item_0=(array)$item_0; ?>
		...
		<tr>
			...
			<td>
				<a class="icon-edit" href="<?php echo Url(DO_ADMIN_INTERFACE.'/user/editrole','id=');?><?php echo $item_0['id']?>">
				</a>
				...
				<div class="modal" id="DOModal_<?php echo $item_0['id']?>" style="display:none">
				  <form id="form<?php echo $item_0['id']?>" action="<?php echo Url('autocrud/Delete/role');?>" method="post">
...
<div >		<?php
		 $pager = DOFactory::GetWidget('paginate','default', DOFactory::GetModel(strtolower('Role'))->Count(),DO_LIST_ROWS);
		 echo $pager->Render();
		 ?></div>
