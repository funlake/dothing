...
<?php $tree_7315859a8bdcf05035d6e2e381a6b554=DOFactory::GetWidget("tree","default",array(DOFactory::GetModel(strtolower('Role'))->Select())) ?>
<?php echo $tree_7315859a8bdcf05035d6e2e381a6b554->Render("
		...
		<input type="hidden" id="__token" name="__token" value="08cbd63f0795892306512a9956ca6c9d"/>
	</form>