...
<?php $tree_1b45db731b82fa090a72151d38050110=DOFactory::GetWidget("tree","default",array(DOFactory::GetModel(strtolower('Group'))->Select())) ?>
<?php echo $tree_1b45db731b82fa090a72151d38050110->Render("
...
<?php $tree_8788d2617285047b14bc34ca63ce8000=DOFactory::GetWidget("tree","default",array(DOFactory::GetModel(strtolower('Role'))->Select())) ?>
<?php echo $tree_8788d2617285047b14bc34ca63ce8000->Render("
					<option value=\"{#id}\" parent=\"{#pid}\">[prefix]{#name}</option>
				"); ?>
	...
	<input type="hidden" id="__token" name="__token" value="874c8f29ebf04d9b73d2d484b361aa30"/>
</form>