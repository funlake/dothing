...
<?php $tree_2ce1cb285cfb355b697fcf2713002086=DOFactory::GetWidget("tree","default",array(DOFactory::GetModel(strtolower('Group'))->Select())) ?>
<?php echo $tree_2ce1cb285cfb355b697fcf2713002086->Render("
...
<?php $tree_8cd712420b3a504a07dce68a6ed0b44b=DOFactory::GetWidget("tree","default",array(DOFactory::GetModel(strtolower('Role'))->Select())) ?>
<?php echo $tree_8cd712420b3a504a07dce68a6ed0b44b->Render("
					<option value=\"{#id}\" parent=\"{#pid}\">[prefix]{#name}</option>
				"); ?>
	...
	<input type="hidden" id="__redirect" name="__redirect" value="http://localhost/dothing/demo/index.php/manage/group"/>
	<input type="hidden" id="group_id" name="id" value="7"/>
	<input type="hidden" id="__token" name="__token" value="3376c86d25dd28ea295de750ee70c7c6"/>
</form>